...
function _negotiateConnectionWithClientOffer() {
  _negotiateConnectionWithClientOffer = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(peerConnection, endpoint, ofr, config) {
...
function _constructClientOffer() {
  _constructClientOffer = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(peerConnection) {
    var offer, ofr;
...
function _postSDPOffer() {
  _postSDPOffer = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(endpoint, data, config) {
...
function _waitToCompleteICEGathering() {
  _waitToCompleteICEGathering = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(peerConnection) {
