...
const getGroupMemberCount = (options) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        console.error(`[Push SDK] - API - Error - API ${exports.getGroupMemberCount.name} -: `, error);
        throw new Error(`[Push SDK] - API - Error - API ${exports.getGroupMemberCount.name} -: ${error}`);
    }
});
exports.getGroupMemberCount = getGroupMemberCount;
//# sourceMappingURL=getGroupMemberCount.js.map